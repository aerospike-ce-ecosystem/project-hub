...
Architecture Decision Record(ADR)는 중요한 아키텍처 결정과 그 근거를 남기는 문서입니다. 각 ADR에는 **결정이 필요했던 맥락, 선택한 방안, 검토한 대안, 예상되는 결과**가 담깁니다. 구현만 봐서는 알기 어려운 “왜 이 방식을 선택했는가”를 이후의 기여자도 이해할 수 있게 하는 것이 목적입니다.
...
| [ADR-0008](./adr/2026-03-10-issueops-ci-workflow.md) | IssueOps 기반 CI 워크플로우 | 2026-03-10 | <Status status="Superseded" /> | <Repo name="aerospike-py" /> <Repo name="acko" /> <Repo name="cluster-manager" /> |
...
| [ADR-0043](./adr/2026-04-07-ci-workflow-suite-standardization.md) | 에코시스템 통합 CI 워크플로우 스위트 표준화 | 2026-04-07 | <Status status="Superseded" /> | <Repo name="aerospike-py" /> <Repo name="acko" /> <Repo name="cluster-manager" /> <Repo name="plugins" /> |
...
| [ADR-0049](./adr/2026-04-07-adr-lifecycle-automation.md) | Project Hub ADR Lifecycle 자동화 아키텍처 | 2026-04-07 | <Status status="Superseded" /> | <Repo name="aerospike-py" /> <Repo name="acko" /> <Repo name="cluster-manager" /> <Repo name="plugins" /> |
...
| [ADR-0053](./adr/2026-08-18-remove-label-triggered-agent-automation.md) | 라벨 트리거 에이전트 자동화 제거 | 2026-08-18 | <Status status="Accepted" /> | <Repo name="aerospike-py" /> <Repo name="acko" /> <Repo name="cluster-manager" /> <Repo name="plugins" /> <Repo name="project-hub" /> |
...
| [ADR-0008](./adr/2026-03-10-issueops-ci-workflow.md) | IssueOps 기반 CI 워크플로우 | 2026-03-10 | <Status status="Superseded" /> |
...
| [ADR-0043](./adr/2026-04-07-ci-workflow-suite-standardization.md) | 에코시스템 통합 CI 워크플로우 스위트 표준화 | 2026-04-07 | <Status status="Superseded" /> |
...
| [ADR-0049](./adr/2026-04-07-adr-lifecycle-automation.md) | Project Hub ADR Lifecycle 자동화 아키텍처 | 2026-04-07 | <Status status="Superseded" /> |
...
| [ADR-0053](./adr/2026-08-18-remove-label-triggered-agent-automation.md) | 라벨 트리거 에이전트 자동화 제거 | 2026-08-18 | <Status status="Accepted" /> |
